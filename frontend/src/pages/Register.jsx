  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", background: "#0f172a" }}>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 40, overflowY: "auto" }}>
        <div className="page-enter" style={{ width: "100%", maxWidth: 400, padding: "20px 0" }}>
          <h2 style={{ fontSize: 24, fontWeight: 700, color: "#f8fafc", margin: "0 0 6px" }}>Create your account</h2>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {[["Google", <GoogleIcon />], ["GitHub", <GitHubIcon />]].map(([label, icon]) => (
              <button key={label} onClick={() => alert(`${label} OAuth requires backend configuration.`)}
